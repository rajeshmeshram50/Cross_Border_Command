...
class HrDocumentTemplateController extends Controller
{
    ...
    {
        // Shared DOCX builder — same renderer used by the generated-document
        // download in HrGeneratedDocumentController so both produce identical
        // header/footer/body output. See HrTemplateDocxRenderer.
        return \App\Services\HrTemplateDocxRenderer::render($row, $filename);
    }
