...
/**
 * One recorded payment against a Purchase Order (see the po_payments migration).
 * Always PO-scoped; `supplier_purchase_invoice_id` only traces the SPI entry
 * point when the payment was recorded from the SPI screen.
 */
