...
/**
 * Branch-isolate the Clause Master (mirrors the Agreement Master change). Adds
 * branch_id to the clause types + library tables so the standard
...
return new class extends Migration {
    private array $tables = ['clm_clause_types', 'clm_clause_library'];
