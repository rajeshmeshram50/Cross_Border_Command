...
<body>
    ...
    @php
        ...
        $__ccyCode = trim((string) ($po->currency ?? 'INR')) ?: 'INR';
    ...
    <div class="content-wrapper">
        ...
        <table class="full-w" style="width:100%; border-collapse:collapse;">
            <tr>
                ...
                <!-- RIGHT: TITLE + PO INFO GRID + VENDOR -->
                <td style="width:50%; vertical-align:top;">
                            ...
                            <tr>
                                <td style="vertical-align:top;">
                                    <h3 style="margin:0; padding:0; font-weight:bold; font-size:20px; line-height:1; color:#777777; letter-spacing:-0.3px; white-space:nowrap; font-family: Helvetica, 'DejaVu Sans', sans-serif;">
                                        {{ strtoupper($pdf_title ?? 'PURCHASE ORDER') }}
                                    </h3>
                                    <div style="margin-top:6px; font-size:9px;">
                                        <div><strong>PO No :</strong> {{ $po->code }}</div>
                    ...
                    {{-- PO INFO GRID — two sub-columns like the reference. --}}
                    <table style="width:100%; border-collapse:collapse; margin-top:12px; font-size:9px; line-height:14px;">
                        <tr>
                            <td style="width:55%; vertical-align:top;">
                                ...
                                <div class="info-line"><strong>Expected Delivery Date :</strong> {{ $po->edd }}</div>
                                <div class="info-line"><strong>Currency :</strong> {{ $po->currency }}</div>
            ...
            <tr>
                ...
                <td style="width:50%; font-size:9px; line-height:14px; vertical-align: top; padding:6px 0;">
                    <div style="margin-left:20px;">
                        <div class="info-line"><strong>Deliver To : </strong>{{ $deliverTo->name }}</div>
                        @if(trim((string) $deliverTo->address) !== '')
                            <div class="info-line">{{ $deliverTo->address }}</div>
                        @endif
                        @if(trim((string) $deliverTo->contact) !== '')
                            <div style="margin-bottom:0;">{{ $deliverTo->contact }}</div>
                        @endif
                    </div>
                </td>
            </tr>
            ...
            <table class="prod_table" style="table-layout: fixed; font-size:9px; width:100%;">
                <thead>
                    <tr style="background-color:{{ $companyDetails->primary_color ?? '#7CB342' }}; color:{{ $companyDetails->primary_text_color ?? '#ffffff' }};">
                        ...
                        <th style="width:14%; text-align: left;">Brand</th>
                ...
                <tbody>
                    @foreach ($products as $i => $product)
                        <tr>
                            ...
                            <td style="width:11%; text-align: right;">{{ number_format($product['rate'], 2) }}</td>
                ...
                <tr>
                    ...
                    <td style="width:32%; vertical-align: top;">
                        <table style="width:100%; font-size:9px; line-height:14px; border-collapse:collapse;">
                            <tr>
                                <td style="padding:3px 0; color:#555;">Shipping Charge:</td>
                                <td style="text-align:right; padding:3px 0;">{{ number_format($totals->shipping, 2) }}</td>
                            </tr>
                            <tr>
                                <td style="padding:3px 0; color:#555;">Packing Charge:</td>
                                <td style="text-align:right; padding:3px 0;">{{ number_format($totals->packing, 2) }}</td>
                            </tr>
                            <tr>
                                <td style="padding:3px 0; color:#555;">Other Charge:</td>
                                <td style="text-align:right; padding:3px 0;">{{ number_format($totals->other, 2) }}</td>
                            </tr>
                            <tr>
                    ...
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td style="width:50%; vertical-align: top; padding-top: 7px; font-size:9px; text-align: right; padding-right: 30px;">
                                Accept &amp; Acknowledge,<strong> {{ $vendor->name }}</strong><br>
                                <br>
