...
<head>
  ...
  <title>Application Update &mdash; {{ $orgName }}</title>
  <style>
...
<div style="display:none;max-height:0;overflow:hidden;font-size:1px;line-height:1px;color:#f3f4f6;">
  An update on your application{{ $jobTitle ? ' for ' . $jobTitle : '' }} at {{ $orgName }}.
</div>
...
<table role="presentation" width="620" cellpadding="0" cellspacing="0" border="0" style="max-width:620px;width:100%;background-color:#ffffff;border-radius:18px;overflow:hidden;box-shadow:0 8px 32px rgba(17,24,39,0.06);">
  ...
  <tr><td style="padding:26px 32px 22px;text-align:center;border-bottom:2px solid #cbd5e1;">
    ...
    @if($brandSub !== '')
    <div style="margin-top:8px;font-size:10.5px;font-weight:700;color:#475569;letter-spacing:3px;text-transform:uppercase;">{{ $brandSub }}</div>
    @endif
  </td></tr>

  <tr><td style="padding:30px 32px 10px;text-align:center;">
    <h1 style="margin:0;font-size:23px;font-weight:800;color:#0f172a;line-height:1.15;">Application Update</h1>
    <p style="margin:8px 0 0;font-size:13.5px;color:#6b7280;line-height:1.6;">
      Regarding your application{{ $jobTitle ? ' for ' . $jobTitle : '' }} at {{ $orgName }}.
    </p>
  </td></tr>
  ...
  <tr><td style="padding:6px 32px 18px;">
    <p style="margin:0;font-size:14px;color:#374151;line-height:1.7;">
      ...
      @if($jobTitle) the <strong style="color:#111827;">{{ $jobTitle }}</strong> role at @endif
      <strong style="color:#111827;">{{ $orgName }}</strong> and for the time you invested in our process.
  ...
  <tr><td style="padding:0 32px 18px;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;">
      <tr><td style="padding:14px 18px;">
        <div style="font-size:10.5px;font-weight:800;color:#475569;letter-spacing:1.4px;text-transform:uppercase;">A note from the team</div>
  ...
  <tr><td style="padding:0 32px 20px;">
    <p style="margin:0;font-size:14px;color:#374151;line-height:1.7;">
      We genuinely appreciate your interest and encourage you to apply for future openings that match your profile.
