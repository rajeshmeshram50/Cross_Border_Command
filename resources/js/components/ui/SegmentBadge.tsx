 ...
 *   High → red     #dc2626 (bg 7%, border 22%)
 *   Less → emerald #0d9488 (bg 7%, border 22%)
...
type Props = {
  ...
  name?: string | null;
  /** Full label ("Highly Regulated") instead of the short one ("High"). */
  full?: boolean;
  style?: CSSProperties;
};

/** Regulatory condition of a segment: High (red) / Less (green). Renders nothing for an unknown status. */
