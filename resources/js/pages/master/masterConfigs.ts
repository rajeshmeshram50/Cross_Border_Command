...
const C: Record<string, MasterConfig> = {
  ...
  kpis: {
    ...
    fields: [
      ...
      { n: 'code', l: 'KPI Code', t: 'text', auto: true, hint: '(auto-generated)', p: 'KPI-XX' },
    ...
    cols: ['code', 'name', 'role_id', 'target_type', 'priority', 'status'],
    colL: ['Code', 'KPI Name', 'Role', 'Target Type', 'Priority', 'Status'],
    uFields: ['name'],
    data: [
      { id: 1, name: 'Monthly Sales Target',  code: 'KPI-01', target_type: 'Currency',   priority: 'High',     status: 'Active' },
      { id: 2, name: 'Revenue Growth',        code: 'KPI-02', target_type: 'Percentage', priority: 'Critical', status: 'Active' },
      { id: 3, name: 'Task Completion Rate',  code: 'KPI-03', target_type: 'Percentage', priority: 'Medium',   status: 'Active' },
      { id: 4, name: 'Customer Satisfaction', code: 'KPI-04', target_type: 'Rating',     priority: 'High',     status: 'Active' },
      { id: 5, name: 'On-time Delivery',      code: 'KPI-05', target_type: 'Boolean',    priority: 'Medium',   status: 'Active' },
    ],
    wtd: [
