/* KycModal — extracted from ClmKycPage so the Document Control Panel can
 * lazy-load the FORM without pulling in the whole master page.
 *
 * ClmDcpPage used to `import { KycModal } from './ClmKycPage'`, which is a plain
...
import type { Kyc, Authority } from './ClmKycPage';
