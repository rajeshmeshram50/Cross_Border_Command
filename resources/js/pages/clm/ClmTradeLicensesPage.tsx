    ...
    <div className="clm-root">
      ...
      <div className="clm-head-card">
        <div className="clm-head-left">
          ...
          <div>
            ...
            <div className="clm-head-title">Trade Licences</div>
            <div className="clm-head-sub">Statutory trade licences — GST, IEC, AD Code, FSSAI, drug licence, BIS / ISI, environmental clearance, fire NOC.</div>
          </div>
        </div>
      ...
      <div className="clm-body-card">
        <div className="clm-tabs">
          <span className="clm-total-pill">Total Trade Licences · <b>{count}</b></span>
        ...
        <div className="clm-table-wrap">
          <table className="clm-table">
            <thead><tr>
              ...
              <th style={{ width: 110, textAlign: 'center' }}>TL ID</th>
              <th>LICENCE NAME</th>
            ...
            <tbody>
              ...
              {!loading && slice.length === 0 && (
                <tr><td colSpan={6} className="clm-empty">
                  <div className="clm-empty-ico"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0891b2" strokeWidth="2"><rect x="3" y="11" width="18" height="11" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg></div>
      ...
      {pendingDelete && createPortal((
        <div className="clm-conf-bd" onClick={() => setPendingDelete(null)}>
          <div className="clm-conf" onClick={e => e.stopPropagation()}>
            ...
            <div className="clm-conf-title">Delete trade licence?</div>
      ...
      <div className="clm-modal" onClick={e => e.stopPropagation()}>
        <div className="clm-modal-head">
          <div className="clm-modal-head-left">
            <div className="clm-modal-head-ico"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2.2"><rect x="3" y="11" width="18" height="11" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg></div>
            <div>
