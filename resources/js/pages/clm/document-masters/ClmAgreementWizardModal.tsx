...
// Transporter, Services) so an agreement's applicable supplier aligns with how
// suppliers are classified on the Purchase Order.
...
// closest current value, so an existing agreement's saved supplier selection
