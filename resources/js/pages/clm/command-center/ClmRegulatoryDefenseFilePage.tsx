    ...
    <div className="rdf-root">
      ...
      <div className="rdf-card">
        <div className="rdf-card-hd">
          ...
          <div className="rdf-search ui-search-abs">
            ...
            <input autoComplete="off" value={search} placeholder={placeholder} onChange={(e) => { setSearch(e.target.value); setPage(1); }} />
...
const SCOPED_CSS = `
.rdf-root { font-family: var(--font-sans); background:#f8fafc; padding:14px 18px 26px; margin:-1rem -0.75rem; min-height:calc(100vh - 70px); color:#0f172a; display:flex; flex-direction:column; gap:13px; }
