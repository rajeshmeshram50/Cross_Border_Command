    ...
    <div className="pof-f">
      ...
      {open && createPortal(
        <div className="pof-dd-pop pof-dd-pop--portal" style={{ left: pos.left, top: pos.top, width: pos.width, maxHeight: 300, overflowY: 'auto' }}>
          {searchable && (
            <div className="ui-search-abs" style={{ position: 'sticky', top: 0, zIndex: 1, padding: 8, background: 'inherit', borderBottom: '1px solid rgba(148,163,184,.18)' }} onMouseDown={e => e.stopPropagation()}>
              <input autoComplete="off" ref={searchRef} value={query} onChange={e => setQuery(e.target.value)} placeholder="Search supplier…"
