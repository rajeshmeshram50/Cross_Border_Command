...
const SupplierScopeGate = lazyWithRetry(() => import('../supplier-management/SupplierScopeGate'));
const AddVendorModal    = lazyWithRetry(() => import('../supplier-management/AddVendorModal'));
